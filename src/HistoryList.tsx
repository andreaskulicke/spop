        ...
        <ScrollView keyboardShouldPersistTaps="always">
            ...
            }
            {
                items
                    ...
                    .sort((a, b) => {
                        if (props.storage) {
                            const aa = a.storages.find(x => x.storageId === props.storage!.id) ? 1 : 0;
                            const bb = b.storages.find(x => x.storageId === props.storage!.id) ? 1 : 0;
                            return bb - aa;
                        }
                        if (props.category) {
                        ...
                        if (props.shop) {
                            const aa = a.shops.find(x => x.shopId === props.shop!.id) ? 1 : 0;
                            const bb = b.shops.find(x => x.shopId === props.shop!.id) ? 1 : 0;
                            return bb - aa;
                        }
                        return 0;
                    })
