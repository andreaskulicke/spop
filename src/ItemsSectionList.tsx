...
function isCollapsedArray(collapsed: ItemsSectionListSection["collapsed"] | undefined): collapsed is [boolean, (expanded: boolean) => void] {
    return (collapsed instanceof Array);
}

function isExpanded(collapsed: ItemsSectionListSection["collapsed"] | undefined): boolean {
...
export function ItemsSectionList(props: {
    ...
    const [expanded, setExpanded] = useState<boolean[]>(props.data.map(x => isExpanded(x.collapsed)));
